...
public class Window extends JFrame {
	...
	public Window() throws IOException {
		...
		String outputBackground = properties.propertiesInit("resources/theme properties.txt", "output.background", 0);
		outputBackground = outputBackground.toUpperCase();
		String[] oBA = outputBackground.split(",");
		String outputForeground = properties.propertiesInit("resources/theme properties.txt", "output.foreground", 0);
		outputForeground = outputForeground.toUpperCase();
		String[] oFA = outputForeground.split(",");
		String inputBackground = properties.propertiesInit("resources/theme properties.txt", "input.background", 0);
		inputBackground = inputBackground.toUpperCase();
		String[] iBA = inputBackground.split(",");
		String inputForeground = properties.propertiesInit("resources/theme properties.txt", "input.foreground", 0);
		inputForeground = inputForeground.toUpperCase();
		String[] iFA = inputForeground.split(",");
		String caretColor = properties.propertiesInit("resources/theme properties.txt", "caret.color", 0);
		caretColor = caretColor.toUpperCase();
		String[] cCA = caretColor.split(",");
		String fontName = properties.propertiesInit("resources/theme properties.txt", "font", 0);
